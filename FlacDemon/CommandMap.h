...
#define flacdemon_command( classType , commandName ) { #commandName , fd_demon_command_function < classType > { &classType::commandName } }
...
protected:
public:
    CommandMap( Target * itarget , fd_commandmap < Target > map ) {
        this->commandMap = map;
        this->target = itarget;
